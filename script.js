...
function send(){
    ...
    Email.send({
        ...
        Username : "ratnadeepritcom@gmail.com",
        Password : "D600028FD3C351A7C4BFD30716A655D58DB5",
        To : 'deepmirikar45@gmail.com',
        From : "ratnadeepritcom@gmail.com",
        Subject : subject,
        Body : body
        }).then(
        message => {
            if(message){
                ...
                Swal.fire({
                    ...
                    html: "<br><br><br><strong>Thank You!</strong><br>Ratnadeep has received your Mail.",
                    timer: 7100,
